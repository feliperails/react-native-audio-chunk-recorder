...
class EventListenerManager {
    ...
    setupNativeListeners(options, stateManager, alertProvider, errorTracker, updateState, updateAudioLevel) {
        ...
        const fullRecordingListener = NativeAudioChunkRecorder_1.AudioChunkRecorderEventEmitter.addListener("onFullRecordingReady", (data) => {
            var _a;
            this.notifyListeners("onFullRecordingReady", data);
            (_a = options.onFullRecordingReady) === null || _a === void 0 ? void 0 : _a.call(options, data);
        });
        this.nativeListeners = [
            chunkListener,
            levelListener,
...
const useAudioRecorderCore = (options = {}) => {
                ...
                if (recordingStartTimeRef.current && !isPausedRef.current) {
                    ...
                    if (elapsed >= state.maxRecordingDuration) {
                        ...
                        stopRecording()
                            ...
                            (_a = options.onMaxDurationReached) === null || _a === void 0 ? void 0 : _a.call(options, maxDurationData);
                            errorTracker.addBreadcrumb({
    ...
    const onFullRecordingReady = (0, react_1.useCallback)((callback) => {
        eventManagerRef.current.addListener("onFullRecordingReady", callback);
        return () => {
            eventManagerRef.current.removeListener("onFullRecordingReady", callback);
        };
    }, []);
